...
const Footer: React.FC = () => {
  return (
    <footer className="bg-[hsl(var(--foreground-dark))] text-[hsl(40,20%,90%)]">
      <Container>
        <div className="flex flex-col items-center py-12 gap-8">
          <div className="flex items-center gap-3">
            ...
            <span className="text-xl font-semibold">Belu Mont</span>
          </div>
          ...
          <div className="text-sm text-[hsl(40,10%,60%)]">
            © 2026 Belu Mont. Todos los derechos reservados.
          </div>
        </div>
      </Container>
    </footer>
